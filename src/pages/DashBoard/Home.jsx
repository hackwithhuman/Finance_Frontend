...
const Home = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 to-black text-gray-100 p-5 sm:p-8 transition-all duration-500">
      <h1 className="text-3xl font-semibold tracking-tight mb-8 text-green-500">
        Dashboard Overview
      </h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mt-10">
        ...
        <div className="bg-gray-800 rounded-2xl shadow-lg p-6 border border-gray-700 hover:shadow-xl transition-all">
          <h2 className="text-xl font-semibold mb-4 text-green-500">Income vs Expense</h2>
        ...
        {/* Pie Chart */}
        <div className="bg-gray-800 rounded-2xl shadow-lg p-6 border border-gray-700 hover:shadow-xl transition-all">
          <h2 className="text-xl font-semibold mb-4 text-green-500">Distribution Overview</h2>
          <ResponsiveContainer width="100%" height={300}>
            <PieChart>
      ...
      <div className="bg-gray-800 rounded-2xl shadow-lg p-6 border border-gray-700 mt-10">
        <h2 className="text-xl font-semibold mb-4 text-green-500">Recent Transactions</h2>
