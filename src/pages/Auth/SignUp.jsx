 ...
 const response = await axiosInstance.post("/api/auth/register", formData, {
  ...
  return (
    <div className="backdrop-blur-md bg-white/10 border border-white/20 rounded-2xl shadow-2xl p-8 w-full max-w-md">
      <div>
        <h2 className="text-3xl font-semibold text-center mb-6 text-green-500 tracking-wide">Sign Up</h2>
        ...
        <form className="mt-6" onSubmit={handleSubmit}>
          ...
          <button
            type="submit"
            className="mt-6 w-full bg-green-500 hover:bg-green-600 text-white py-2 rounded-lg font-medium focus:ring-4 focus:ring-green-400 transition-all"
          >
            Create Account
          </button>
        </form>
